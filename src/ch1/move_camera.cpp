...
float lastX = 400.0f, lastY = 300.0f; // 初始屏幕中心
...
void processInput(GLFWwindow* window) {
    ...
    float cameraSpeed = 2.5f * deltaTime; //平衡帧率差异
...
void mouse_callbcak(GLFWwindow* window, double xposIn, double yposIn) {
    /*
...
int main() {
    ...
    glfwSetCursorPosCallback(window, mouse_callbcak);
