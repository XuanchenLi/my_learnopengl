...
int main() {
...
#endif
    //initialize window
    GLFWwindow* window = glfwCreateWindow(1440, 920, "LearnOpenGL", NULL, NULL);
    ...
    glfwSetWindowPos(window, (mode->width - 1440) / 2, (mode->height - 920) / 2);
    ...
    Shader ourShader("../Shader/mvp_shader.vs", "../Shader/tex_shader.fs");
