...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        */
        ...
        glm::vec3 color = glm::vec3((sin(currentFrame) + 1.0) / 2, (cos(currentFrame) + 1.0) / 2 , 0.5f);
        ourShader.setVec3("spotLight.ambient", 0.1f, 0.1f, 0.1f);
        ourShader.setVec3("spotLight.diffuse", color);
        ourShader.setVec3("spotLight.specular", color);
