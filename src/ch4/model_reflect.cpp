...
int main()
{
    ...
    //折射
    //Shader shader("../Shader/model_reflect.vs", "../Shader/model_reflect.fs");
    Shader shader("../Shader/model_reflect.vs", "../Shader/model_reflect.fs");
...
*/
    ...
    while(!glfwWindowShouldClose(window))
    {
        ...
        */
        ...
        shader.setVec3("spotLight.diffuse", color);
        ...
        //模型加载器已经用了4个纹理单元(diffuse, specular, normal, height)，需要给天空盒单独用第五个
        glActiveTexture(GL_TEXTURE4);
        shader.setInt("material.texture_skybox", 4);
