...
int main()
{
    ...
    // -------------------------
    //反射
    //Shader shader("../Shader/environment_map_reflect.vs", "../Shader/environment_map_reflect.fs");

    //折射
    Shader shader("../Shader/environment_map_refract.vs", "../Shader/environment_map_refract.fs");
