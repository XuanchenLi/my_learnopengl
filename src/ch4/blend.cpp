...
int main()
{
    ...
    // -------------------------
    Shader shader("../Shader/depth_test.vs", "../Shader/blending.fs");
    ...
    glBindVertexArray(0);
    //vegetation VAO
    unsigned int vetegationVAO, vegetationVBO;
    glGenVertexArrays(1, &vetegationVAO);
    glGenBuffers(1, &vegetationVBO);
    glBindVertexArray(vetegationVAO);
    ...
    unsigned int vegetationTexture = loadTexture("../Texture/grass.png");
