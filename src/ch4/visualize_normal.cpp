...
int main()
{
    ...
    // -------------------------
    Shader ourShader("../Shader/default_model.vs", "../Shader/default_model.fs");
    Shader normalShader("../Shader/visualize_normal.vs", "../Shader/visualize_normal.fs", "../Shader/visualize_normal.gs");
    // load models
    // -----------
